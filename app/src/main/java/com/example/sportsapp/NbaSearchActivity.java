...
import com.example.sportsapp.databinding.ActivityNbaSearchBinding;

public class NbaSearchActivity extends AppCompatActivity {
    ...
    ActivityNbaSearchBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityNbaSearchBinding.inflate(getLayoutInflater());
    ...
    public static Intent nbaSearchIntentFactory(Context context){
        Intent intent = new Intent(context, NbaSearchActivity.class);
        return intent;
    }
    ...
    private void showLogoutDialog() {
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(NbaSearchActivity.this);
